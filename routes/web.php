...
use App\Http\Controllers\Staff\DataExportController as DataExportController;
...
Route::middleware(['auth','teachingteam'])->group(function () {
    ...
    Route::get('staff/export', [DataExportController::class, 'index'])->name('staff_dataexport.index');
});
